...
import './globals.css'
import { Inter, Unbounded, Playwrite_HU } from 'next/font/google'
...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang='en'>
      ...
      <body
        className={`${plhu.variable} ${unbounded.variable} ${inter.variable} antialiased`}
      >
        <SearchProvider>
          <CategoryProvider>
            <UserProvider>
              <RouteGuard>
                ...
                {/* Scroll Buttons */}
                {isVisible && (
                  <div className='fixed z-20 bottom-4 right-4 max-sm:bottom-[70px] md:bottom-16 md:right-16 flex flex-col space-y-2'>
                    <button
                      onClick={scrollToTop}

...
function DeleteSeasonModal({ isOpen, onClose, onDelete }) {
  return (
    <Modal size={'md'} isOpen={isOpen}>
      ...
      <ModalBody>
        ...
        <div className='mt-4 p-3 bg-red-100 rounded-md text-red-700'>
          <p>
            <strong>Note:</strong> Deleting this season will automatically
            remove all the products associated with it.
          </p>
        </div>
      </ModalBody>
      <ModalFooter>

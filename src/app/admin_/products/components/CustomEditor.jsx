...
const MenuBar = ({ editor }) => {
  ...
  return (
    <div className='flex sticky top-0 z-20 gap-3 border p-2 bg-blue-800 text-white'>
      <button
        ...
        type='button'
      >
        <HeadingIcon strokeWidth={3} size={18} />
      </button>
      <button
      ...
      <button
        ...
        type='button'
      >
        <ListOrdered strokeWidth={3} size={18} />
      </button>

      <button onClick={handleLink}>
        <LinkIcon strokeWidth={3} size={18} />
      </button>
...
const CustomEditor = ({ value, onChange, images, label, name }) => {
  ...
  const editor = useEditor({
    ...
    content: value || '',
    editorProps: {
      attributes: { class: 'p-3 leading-5 focus:outline-none' },
      handleDOMEvents: {
        click: (view, event) => {

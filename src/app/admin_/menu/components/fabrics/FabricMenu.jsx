...
import AddEditFabric from './AddEditFabric'
...
const FabricMenu = () => {
  ...
  async function fetchData() {
    try {
      const response = await axios.get('/api/admin/menu?type=fabrics')
  ...
  const onDelete = async () => {
    try {
      const response = await axios.delete(`/api/admin/menu/fabrics`, {
